...
local RemoteLbl    = createLabel("RemoteLbl", "REMOTE :", UDim2.new(0, 5, 0, 20))
local RemoteBox    = createTextBox("RemoteBox", "Remote Number", "6", UDim2.new(0, 62, 0, 20))

local HatchLbl     = createLabel("HatchLbl", "STATUS :", UDim2.new(0, 5, 0, 45), 52.5, 20, Color3.fromRGB(50, 50, 50))
local StatusLbl    = createLabel("StatusLbl", "Inactive", UDim2.new(0, 62, 0, 45), 52.5, 20, Color3.fromRGB(30, 30, 30), Color3.fromRGB(255, 50, 50))

local AntiAfkLbl   = createLabel("AntiAfkLbl", "AFK:Time", UDim2.new(0, 5, 0, 70), 52.5, 20, Color3.fromRGB(50, 50, 50))
local AfkTimeLabel = createLabel("AfkTimeLabel", "0:0:0", UDim2.new(0, 62, 0, 70), 52.5, 20, Color3.fromRGB(50, 50, 50))

local SwitchBtn    = createButton("SwitchBtn", "Turn On", UDim2.new(0, 5, 0, 95), 110, 20, Color3.fromRGB(40, 120, 40))
